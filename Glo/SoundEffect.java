 ...
 * 
 * https://gist.github.com/figengungor/5673813
 * the code^^^^
 * 
 * resource:
 * https://www.ntu.edu.sg/home/ehchua/programming/java/J8c_PlayingSound.htmlS
 */

public enum SoundEffect {
    MENU("images/menu_button.wav"),   

    POWERUP("images/powerup.wav"),

    SHOOT("images/shoot.wav"),
    
    OOF("images/oof.wav"),

    UNDERTALE("images/Undertale.wav");
